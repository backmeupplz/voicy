...
const localizations = {
  ...
  '👋 Please, select the engine of speech recognition. Google Speech is more accurate, but has to be set up with your Google Cloud credentials (a bit tedious). Yandex SpeechKit is pretty accurate, free, but has limited list of languages. Wit.ai is less accurate, free, but has plenty of languages. Please, note that all three support different languages, so pick the one that suits you the best.': {
    ...
    ru:
      '👋 Пожалуйста, выберите движок распознавания речи. Google Speech более точный, но требует, чтобы вы установили аутентификационный файл Google Cloud (немного сложно). Yandex SpeechKit достаточно точный, бесплатный, но поддерживает меньше языков. Wit.ai наименее точный, бесплатный, но работает с большим количеством языков. Стоит отметить, что разные движки поддерживают разные языки, так что выберите тот, который подходит вам наиболее всего.',
  },
  ...
  '👍 Now *Voicy* speaks *$[1]* (wit.ai) in this chat. Thank you!': {
    ...
    tr: '👍 Artık *Voicy* bu sohbette *$[1]* (wit.ai) kullanıyor. Teşekkürler.',
    sv:
