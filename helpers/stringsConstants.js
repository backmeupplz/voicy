const localizations = {
  '📁 Wonderful! *Voicy* will *ignore* all audio files in this chat since now.': {
    ...
    ru: '📁 Wonderful! *Voicy* will *ignore* all audio files in this chat since now.',
  },
  '📁 Wonderful! *Voicy* will *try to recognize* all audio files in this chat since now.': {
    ...
    ru: '📁 Wonderful! *Voicy* will *try to recognize* all audio files in this chat since now.',
  },
  'Reply to this message with the Google Cloud credentials file (.json) to setup Google Speech voice recognition. Not sure what is this and how to get it? Check out [our quick tutorial](https://google.com).': {
    en: 'Reply to this message with the Google Cloud credentials file (.json) to setup Google Speech voice recognition. Not sure what is this and how to get it? Check out [our quick tutorial](https://google.com).',
    ru: 'Reply to this message with the Google Cloud credentials file (.json) to setup Google Speech voice recognition. Not sure what is this and how to get it? Check out [our quick tutorial](https://google.com).',
  },
  'Sorry, you should reply with a credentials document.': {
    en: 'Sorry, you should reply with a credentials document.',
    ru: 'Sorry, you should reply with a credentials document.',
  },
  'Sorry, document\'s mime type should be \'text/plain\'.': {
    en: 'Sorry, document\'s mime type should be \'text/plain\'.',
    ru: 'Sorry, document\'s mime type should be \'text/plain\'.',
  },
  'Congratualations! *Voicy* got the credentials file for the *$[1]* Google Cloud Project. Now you are able to use Google Speech recognition.': {
    en: 'Congratualations! *Voicy* got the credentials file for the *$[1]* Google Cloud Project. Now you are able to use Google Speech recognition.',
    ru: 'Congratualations! *Voicy* got the credentials file for the *$[1]* Google Cloud Project. Now you are able to use Google Speech recognition.',
  },
  '😎 *Voicy* converts speech to text from any voice messages and audio files (.ogg, .flac, .wav, .mp3) it receives. You can either talk to *Voicy* in the private chat or add it to a group.\n\nIf you want to use this bot in private messages, please, create a private group with anyone and add *Voicy* there. If you want to add *Voicy* to a group chat, please, add it as a prticipant on the group profile or to the group in the *Voicy* bot profile.\n\n/help — Shows this message 😱\n/engine — Lets you pick a voice recognition engine: wit.ai, Yandex SpeechKit or Google Speech ⚙\n/language — Lets you pick a voice recognition language 📣\n/lock — Toggles lock or unlock of non-admins using commands in group chats 🔑\n/files — Toggles if the bot should attempt to convert audio files or just ignore them 📁\n/silent — Toggles silent mode when no extra messages like `Voice recognition is initiated` are sent 😶\n/google — Setup google credentials for Google Speech 🦆\n\nLike this bot? Leave a review [here](https://telegram.me/storebot?start=voicybot) 👍\n\nAddress any concerns and questions to my creator — @borodutch 🦄': {
    ...
    ru: '😎 *Voicy* converts speech to text from any voice messages and audio files (.ogg, .flac, .wav, .mp3) it receives. You can either talk to *Voicy* in the private chat or add it to a group.\n\nIf you want to use this bot in private messages, please, create a private group with anyone and add *Voicy* there. If you want to add *Voicy* to a group chat, please, add it as a prticipant on the group profile or to the group in the *Voicy* bot profile.\n\n/help — Shows this message 😱\n/engine — Lets you pick a voice recognition engine: wit.ai, Yandex SpeechKit or Google Speech ⚙\n/language — Lets you pick a voice recognition language 📣\n/lock — Toggles lock or unlock of non-admins using commands in group chats 🔑\n/files — Toggles if the bot should attempt to convert audio files or just ignore them 📁\n/silent — Toggles silent mode when no extra messages like `Voice recognition is initiated` are sent 😶\n/google — Setup google credentials for Google Speech 🦆\n\nLike this bot? Leave a review [here](https://telegram.me/storebot?start=voicybot) 👍\n\nAddress any concerns and questions to my creator — @borodutch 🦄',
  },
  '😅 Sorry, but this command only works in group chats': {
    en: '😅 Sorry, but this command only works in group chats',
    ru: '😅 Sorry, but this command only works in group chats',
  },
  '🔑 Great! *Voicy* will now respond only to command calls sent by *admins* in this chat.': {
    ...
    ru: '🔑 Great! *Voicy* will now respond only to command calls sent by *admins* in this chat.',
  },
  '🔑 Great! *Voicy* will now respond only to command calls from *anyone* in this chat.': {
    ...
    ru: '🔑 Great! *Voicy* will now respond only to command calls from *anyone* in this chat.',
  },
  '😶 Magnificent! *Voicy* will now work in *silent mode*: it will not send any messages to the chat except for the actual voice transcriptions.': {
    ...
    ru: '😶 Magnificent! *Voicy* will now work in *silent mode*: it will not send any messages to the chat except for the actual voice transcriptions.',
  },
  '😏 Magnificent! *Voicy* will now work in *usual mode*: it will send `Voice recognition is initiated` messages right after it receives voice messages.': {
    ...
    ru: '😏 Magnificent! *Voicy* will now work in *usual mode*: it will send `Voice recognition is initiated` messages right after it receives voice messages.',
  },
  '👋 Hello there! *Voicy* is a voice recognition bot that converts all voice messages and audio files (.ogg, .flac, .wav, .mp3) it gets into text.\n\n*Voicy* supports three voice recognition engines: wit.ai, Yandex SpeechKit and Google Speech. Initialy it\'s set to use wit.ai but you can switch to Google Speech or Yandex SpeechKit anytime in /engine. More information in /help.': {
    ...
    ru: '👋 Hello there! *Voicy* is a voice recognition bot that converts all voice messages and audio files (.ogg, .flac, .wav, .mp3) it gets into text.\n\n*Voicy* supports three voice recognition engines: wit.ai, Yandex SpeechKit and Google Speech. Initialy it\'s set to use wit.ai but you can switch to Google Speech or Yandex SpeechKit anytime in /engine. More information in /help.',
  },
  ...
  'Only the person who started command can select options': {
    ...
    ru: 'Only the person who started command can select options',
  },
  ...
  '👋 Please select the language of speech recognition for wit.ai.': {
    ...
    ru: '👋 Please select the language of speech recognition for wit.ai.',
  },
  '👍 Now *Voicy* speaks *$[1]* (wit.ai) in this chat. Thank you!': {
    en: '👍 Now *Voicy* speaks *$[1]* (wit.ai) in this chat. Thank you!',
    ru: '👍 Now *Voicy* speaks *$[1]* (wit.ai) in this chat. Thank you!',
  },
  '👋 Please select the language of speech recognition for Google Speech.': {
    ...
    ru: '👋 Please select the language of speech recognition for Google Speech.',
  },
  '👍 Now *Voicy* speaks *$[1]* (Google Speech) in this chat. Thank you!': {
    en: '👍 Now *Voicy* speaks *$[1]* (Google Speech) in this chat. Thank you!',
    ru: '👍 Now *Voicy* speaks *$[1]* (Google Speech) in this chat. Thank you!',
  },
  '_👮 I can\'t recognize voice messages larger than 20 megabytes_': {
    ...
    ru: '_👮 I can\'t recognize voice messages larger than 20 megabytes_',
  },
  '_🦄 Voice recognition is initiated..._': {
    en: '_🦄 Voice recognition is initiated..._',
    ru: '_🦄 Voice recognition is initiated..._',
  },
  '_👮 Wit.ai cannot recognize voice messages longer than 50 seconds_': {
    ...
    ru: '_👮 Wit.ai cannot recognize voice messages longer than 50 seconds_',
  },
  '_👮 Please, speak clearly, I couldn\'t recognize that_': {
    en: '_👮 Please, speak clearly, I couldn\'t recognize that_',
    ru: '_👮 Please, speak clearly, I couldn\'t recognize that_',
  },
  '_👮 I couldn\'t recognize that_': {
    en: '_👮 I couldn\'t recognize that_',
    ru: '_👮 I couldn\'t recognize that_',
  },
  '😮 Please, setup google credentials with the /google command or change the engine with the /engine command. Your credentials are not setup yet.': {
    en: '😮 Please, setup google credentials with the /google command or change the engine with the /engine command. Your credentials are not setup yet.',
    ru: '😮 Please, setup google credentials with the /google command or change the engine with the /engine command. Your credentials are not setup yet.',
  },
}
